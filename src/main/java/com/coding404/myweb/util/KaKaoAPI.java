...
public class KaKaoAPI {
	...
	public String getToken(String code) {
		...
		try {
			...
			String req = "grant_type=authorization_code"
						+ "&client_id=c07e258d047fc39f548e6276ec864b08"
	...
	public Map<String, Object> getUser(String token) {
		...
		try {
			...
			conn.setRequestProperty("Authorization", "Bearer " + token); //api를 사용하기 위해 발급받은 토큰값 (Bearer 뒤에 띄어쓰기 필수)
			
			
			//쿼리파라미터는 없기 때문에 writer는 생략 가능
